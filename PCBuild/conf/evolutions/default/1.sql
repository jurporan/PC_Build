...
create table "CASE" ("ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"NAME" VARCHAR NOT NULL,"MANUFACTURER" VARCHAR NOT NULL,"WIDTH" REAL NOT NULL,"HEIGHT" REAL NOT NULL,"LENGTHT" REAL NOT NULL,"POPULARITY" INTEGER NOT NULL,"PRICE" REAL NOT NULL,"IMAGE_URL" VARCHAR NOT NULL);
...
create table "MEMORY" ("ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"NAME" VARCHAR NOT NULL,"MANUFACTURER" VARCHAR NOT NULL,"MEMORY_SIZE" REAL NOT NULL,"CONSUMPTION" REAL NOT NULL,"POPULARITY" INTEGER NOT NULL,"PRICE" REAL NOT NULL,"IMAGE_URL" VARCHAR NOT NULL);
