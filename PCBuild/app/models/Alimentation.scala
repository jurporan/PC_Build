...
case class Alimentation(id: Int, manufacturer: String, model: String, power: Int, imgUrl: String, price: Float, popularity: Int)
...
class AlimentationTable(tag: Tag) extends Table[Alimentation](tag, "ALIMENTATION") {
  ...
  def power = column[Int]("POWER", O.NotNull)
